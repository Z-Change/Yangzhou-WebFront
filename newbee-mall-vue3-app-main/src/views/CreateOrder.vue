...
<template>
  <div class="create-order">
    ...
    <div class="pay-wrap">
      ...
      <van-button @click="handleCreateOrder" class="pay-btn" color="#FB7299" type="primary" block>
        生成订单</van-button>
    </div>
    <van-popup closeable :close-on-click-overlay="false" v-model:show="state.showPay"
      position="bottom" :style="{ height: '30%' }" @close="close">
